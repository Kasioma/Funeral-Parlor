...
import { Plus, Scale, Twitter, Sparkle } from "lucide-react";
const Hero = () => {
  return (
    <div className="section-padding bg-background-950 py-7 text-text-50">
      ...
      <div className="relative mx-auto my-7 w-10/12 rounded">
        ...
        <div className="absolute top-0 z-0 h-3/4 w-11/12 -translate-x-[8%] translate-y-[40%] rounded border-2 border-secondary-300 bg-accent-100 p-2">
          <div className="my-1 h-3 rounded-full bg-secondary-200"></div>
          <div className="my-2 h-3 rounded-full bg-secondary-300"></div>
        </div>
        <div className="absolute bottom-16 z-20 h-1/5 w-2/5  -translate-x-[40%] translate-y-[5%] rounded border-2 border-secondary-300 bg-secondary-600 p-2">
          ...
          <div className="rounded-ful my-2 mt-3 flex h-3 items-center justify-center gap-1">
            ...
            <div className="flex w-4/5 justify-center rounded-full bg-secondary-700 text-xs font-thin">
              87%
            </div>
            <div className="rounded bg-secondary-700">
              <Plus className="h-4 w-4" />
